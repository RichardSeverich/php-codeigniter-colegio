<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Modelo_inscripciones extends CI_Model
	{
			...
			{
				$this -> db->insert('inscripciones',array('ciestudiante' => $datos['ciestudiante'],
			...
			{
				$this -> db->insert('pensiones',array('numinscripcion' => $datos['numinscripcion'],
			...
			function buscar_inscripcion($ciestudiante,$numcurso)   // por num curso y ciestudiante
			{
			...
			{
				$this->db->where('numinscripcion',$numinscripcion);  // estos son los campos lo que esta entre comillas es de la base de datos
