<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Modelo_gestion extends CI_Model
	{
			...
			{
				$this -> db->insert('gestion',array('aniogestion' => $datos['aniogestion'],
			...
			function buscar_gestion($aniogestion)
			{
					...
					$this ->db->where('aniogestion',$aniogestion);  // primero: atributo de la base de datos, luego con que va a comparar
