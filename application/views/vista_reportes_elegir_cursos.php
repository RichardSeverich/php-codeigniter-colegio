...
echo form_open('controlador_reportes/direccionar_reportes_estudiantes_deudores', $attributes); // primero  pongo el archivo php luego la funcion
?>
<html>
...
<body>
  ...
  <center>
    ...
    echo form_open('controlador_reportes/direccionar_menu_principal_secretaria', $attributes);
    ...
    <tr class="">
      ...
      if ($cursos != FALSE) {
        foreach ($cursos->result() as $row) {
          ...
          echo '<td><a href="' . base_url() . 'index.php/controlador_reportes/direccionar_reportes_estudiantes_deudores_por_curso/'
            . $row->numcurso . '/' .
            $row->aniogestion . '/' .
            $row->niveleducativo . '/' .
            $row->nombrecurso . '/' .
