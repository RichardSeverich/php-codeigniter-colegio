...
echo form_open('controlador_gestion/modificar_gestion/'.$row->aniogestion,$attributes) // primero  pongo el archivo php, luego la funcion
?>
<?php 
				  ...
				  <div>					
					<fieldset id="actions">
					  ...
					  <?php  
							...
							echo form_open('controlador_gestion/direccionar_menu_principal',$attributes); // primero  pongo el archivo php luego la funcion
