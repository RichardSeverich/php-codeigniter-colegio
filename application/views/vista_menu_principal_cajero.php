  ...
  <div id="main-wrapper">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center templatemo-logo margin-top-20">
      <h1 class="templatemo-site-title">
        <a href="#">MENU PRINCIPAL CAJERO</a>
      </h1>
        ...
        <div class="templatemo-content">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
                <a href="#testimonials" class="change-section">
                  <div class="black-bg btn-menu">
                    <h2>Ges. DatosDosificacion</h2>
                  </div>
                </a>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
                <a href="<?php echo base_url(); ?>index.php/controlador_pensiones/direccionar_menu_gestionar_cobro_pensiones/<?php echo $ciusuario; ?>" class="">
                  <div class="black-bg btn-menu">
                    <h2>Ges. Pago de Pensiones</h2>
                  </div>
                </a>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
          ...
          <section id="testimonials-section" class="inactive">
            ...
            <center>
              ...
              echo form_open('controlador_dosificacion/direccionar_registro_dosificacion/' . $ciusuario . '', $attributes); //abrir el form
              $attributes = array('style' => 'width:242px; height:70px', 'class' => 'btn btn-primary', 'id' => 'btnregistroinscripcion', 'name' => 'btnregistroinscripcion');
              ...
              echo form_open('controlador_dosificacion/mostrar_dosificacion/' . $ciusuario . '', $attributes);
              $attributes = array('style' => 'width:242px; height:70px', 'class' => 'btn btn-primary', 'id' => 'btnbuscarinscripciones', 'name' => 'btnbuscarinscripciones');
