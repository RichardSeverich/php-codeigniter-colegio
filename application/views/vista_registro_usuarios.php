...
echo form_open('controlador_usuarios/registrar_usuario',$attributes) // primero  pongo el archivo php luego la funcion
?>
<?php 
	$ciusuario =  array (
		'name' => 'ciusuario',
				  ...
				  <div>					
					<fieldset id="actions">
					  ...
					  <?php  
							...
							echo form_open('controlador_usuarios/direccionar_menu_principal',$attributes); // primero  pongo el archivo php luego la funcion
