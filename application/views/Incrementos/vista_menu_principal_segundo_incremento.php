...
<body>
  <div id="main-wrapper">
    ...
    <div class="image-section">
      <div class="image-container">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-1.jpg" id="menu-img" class="main-img inactive" alt="Zoom HTML5 Template by templatemo.com">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-2.jpg" id="products-img" class="inactive" alt="Product">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-3.jpg" id="services-img" class="inactive" alt="Services">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-4.jpg" id="about-img" class="inactive" alt="About">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-5.jpg" id="contact-img" class="inactive" alt="Contact">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-6.jpg" id="company-intro-img" class="main-img inactive" alt="Company Intro">
        <img src="http://localhost/codeigniter2/docs_menu_principal/images/zoom-bg-7.jpg" id="testimonials-img" class="main-img inactive" alt="Testimonials">
      </div>
    </div>
        ...
        <div class="templatemo-content">
          ...
          <section id="menu-section" class="active">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
                <a href="http://localhost/codeigniter2/" class="">
                  <div class="black-bg btn-menu">
                    <h2>Salir</h2>
                  </div>
                </a>
          ...
          <section id="testimonials-section" class="inactive">
            ...
            <center>
              ...
              echo form_open('controlador_dosificacion/direccionar__registrar_dosificacion', $attributes); //abrir el form
              $attributes = array('style' => 'width:242px; height:70px', 'class' => 'btn btn-primary', 'id' => 'btnregistroinscripcion', 'name' => 'btnregistroinscripcion');
              echo form_submit($attributes, 'REGISTRAR INSCRIPCIONES');
              echo form_close();
              echo '&&&';
              ...
              echo form_open('controlador_dosificacion/mostrar_inscripciones', $attributes);
              $attributes = array('style' => 'width:242px; height:70px', 'class' => 'btn btn-primary', 'id' => 'btnbuscarinscripciones', 'name' => 'btnbuscarinscripciones');
              echo form_submit($attributes, 'BUSCAR INSCRIPCIONES');
              echo form_close();
              echo '&&&';
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer">
        <p class="footer-text">Copyright &copy; 2014 Richard Severich
  ...
  <script src="http://localhost/codeigniter2/docs_menu_principal/js/jquery.min.js"></script>
  <script src="http://localhost/codeigniter2/docs_menu_principal/js/jquery-ui.min.js"></script>
  <script src="http://localhost/codeigniter2/docs_menu_principal/js/jquery.backstretch.min.js"></script>
  <script src="http://localhost/codeigniter2/docs_menu_principal/js/templatemo_script.js"></script>
</body>
