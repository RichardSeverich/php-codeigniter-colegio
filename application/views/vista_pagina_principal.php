...
<head>
  ...
  <!--  
  <script <?php // echo link_tag('docs_paginaweb/js/jquery-1.10.2.min.js');  
          ?> </script> 
  <script <?php //echo link_tag('docs_paginaweb/js/jquery.lightbox.js');  
          ?> </script> 
  <script <?php //echo link_tag('docs_paginaweb/js/templatemo_custom.js');  
          ?>  </script> 
   -->
...
<body>
  ...
  <div class="templatemo_footer">
    <div class="container">
      <div class="row">
        <div class="col-md-9 col-sm-12">Copyright &copy; 2014
