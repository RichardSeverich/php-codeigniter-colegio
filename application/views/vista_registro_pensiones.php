...
<?php
	   ...
	   echo form_open('controlador_pensiones/direccionar_generar_facturas/'.$row->montopension.'/'
																		   .$contador.'/'
																		   .$row->numinscripcion.'/'
																		   .$row0->ciestudiante.'/'
																		   .$ciusuario.''
		...
		$numinscripcionSalir=$row->numinscripcion; // numero de inscripcion para mandar al boton/funcion de salir menu principla
