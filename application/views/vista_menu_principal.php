        ...
        <div class="templatemo-content">
          ...
          <section id="menu-section" class="active">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
                <a href="<?php echo base_url(); ?>index.php/controlador_pensiones/direccionar_menu_gestionar_cobro_pensiones" class="">
                  <div class="black-bg btn-menu">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
                <a href="<?php echo base_url() . 'index.php/controlador_reportes/direccionar_reportes_menu' ?>" class="">
                  <div class="black-bg btn-menu">
                    <h2>Reportes</h2>
                  </div>
                </a>
