					...
					<section id="testimonials-section" class="">
                            <div class="row">
                                <div class="black-bg col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <h2 class="text-center">REPORTES SECRETARIA</h2>
							...
							echo form_open('controlador_reportes/direccionar_reportes_estudiantes_deudores',$attributes); //abrir el form
						
							 
							$attributes = array('style'=>'width:300px; height:70px','class'=>'btn btn-primary','id' => 'btnreportes','name' => 'btnreportes');
							echo form_submit($attributes,'ESTUDIANTES CON DEUDAS');
							echo form_close();
							echo '&&&';
							?>
