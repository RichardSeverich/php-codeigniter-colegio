...
echo form_open('controlador_cursos/modificar_cursos/'.$row1->numcurso,$attributes) // primero  pongo el archivo php luego la funcion
?>
...
<body>
			<h1 id="ff-proof" class="ribbon">MODIFICAR CURSO &nbsp;&nbsp;</h1>
				...
				<div>				  
				  ...
				  <div>			
						<select name="aniogestion" class="form" id = "inputs"  style = "width:242px; height:40px"  >
							<option value = "<?php echo $row1->aniogestion; ?>" > <?php echo $row1->aniogestion; ?></option>
                  ...
                  <div>
						<select name="niveleducativo" class="form" id = "inputs"  style = "width:242px; height:40px"  >
							<option value = "<?php echo $row1->niveleducativo; ?>" > <?php echo $row1->niveleducativo; ?></option>
				 ...
				 <div>				  
                  ...
                  <div>
						<select name="nombrecurso" class="form" id = "inputs"  style = "width:242px; height:40px"  >		
							<option value = "<?php echo $row1->nombrecurso; ?>" > <?php echo $row1->nombrecurso; ?></option>
                  ...
                  <div>
						<select name="paralelocurso" class="form" id = "inputs"  style = "width:242px; height:40px"  >		
							<option value = "<?php echo $row1->paralelocurso; ?>" > <?php echo $row1->paralelocurso; ?></option>
				  ...
				  <div>					
					<fieldset id="actions">
					  ...
					  <?php         
							...
							echo form_submit($attributes,'MODIFICAR CURSO');
							echo form_close();
					  ?>
